...
class Loader30 extends StatefulWidget {
  const Loader30({
    Key? key,
    required this.color,
  ...
  @override
  _Loader30State createState() => _Loader30State();
}

class _Loader30State extends State<Loader30> with SingleTickerProviderStateMixin {
